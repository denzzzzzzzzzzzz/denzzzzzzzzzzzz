...
1. **[Portfolify](link-to-repo)** - A web platform helping developers build and host professional portfolios instantly.
2. **[COMSATS Bio-Database](link-to-repo)** - A centralized management system for departmental records.
3. [cite_start]**[Alzheimer's Detection](link-to-repo)** - MRI-based detection using Convolutional Neural Networks[cite: 51, 52].
4. [cite_start]**[BioDataHub](link-to-repo)** - A WordPress community platform for bioinformatics researchers[cite: 45, 46].

---

📫 **How to reach me:**
- [cite_start]📧 Email: daniyalhameed033@gmail.com [cite: 3]
- [cite_start]🔗 LinkedIn: [daniyal-hameed](https://www.linkedin.com/in/daniyal-hameed-904868332) [cite: 3]
